<?php
$title = 'Política de cookies | La Llave de tu Pyme';
$description = 'Información sobre las cookies utilizadas por La Llave de tu Pyme.';
$robots = 'noindex,follow';
$canonical = 'https://lallavedetupyme.com/politica-de-cookies/';
$headerType = 'minimal';
$footerType = 'minimal';
...
<main id="contenido" class="legal-page">
    <section class="page-hero"><div class="container"><span class="eyebrow">Navegación sin sorpresas</span><h1>Política de cookies</h1><p class="hero-lead">Puedes aceptar o rechazar la analítica y la medición publicitaria. Tu elección no afecta al envío del formulario.</p></div></section>
    <section class="section"><div class="container legal-copy">
      <h2>1. Qué es una cookie</h2>
      <p>Una cookie es un pequeño archivo que un sitio web puede guardar en el dispositivo para recordar información o permitir determinadas funciones.</p>
      <h2>2. Cookie técnica utilizada</h2>
      <div class="legal-table" role="region" aria-label="Detalle de cookies" tabindex="0"><table><thead><tr><th>Nombre</th><th>Tipo</th><th>Duración</th><th>Finalidad</th></tr></thead><tbody><tr><td>llave_contacto</td><td>Propia y técnica</td><td>Sesión</td><td>Proteger el formulario frente a envíos repetidos y mantener su funcionamiento seguro.</td></tr></tbody></table></div>
      <p>Esta cookie es estrictamente necesaria y se crea al navegar para preparar y confirmar el formulario. No se utiliza para publicidad, medición de audiencias ni seguimiento entre sitios.</p>
      <h2>3. Analítica opcional</h2>
      <p>Si pulsas «Aceptar», cargamos Google Analytics mediante la etiqueta <strong>GT-WRGZMMBM</strong> para conocer el uso agregado de las páginas y registrar solicitudes confirmadas. Google puede crear cookies como <strong>_ga</strong> y variantes asociadas a la propiedad, con una duración máxima habitual de dos años. No se carga esta herramienta antes de tu consentimiento.</p>
      ...
      <p>Si aceptas, activamos el píxel de Meta para medir visitas. En la página de gracias de community manager enviamos el evento CompleteRegistration una vez por carga de la página, también si accedes directamente o la recargas. Meta recibe información técnica del navegador y de la página visitada para medir la respuesta a los anuncios y puede utilizar cookies como _fbp y _fbc para la atribución publicitaria.</p>
